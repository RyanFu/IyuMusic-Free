...
- (id) initWithMusicWord:(NSInteger)_wordId key:(NSString *)_key audio:(NSString *)_audio pron:(NSString *)_pron def:(NSString *)_def date:(NSString *)_date checks:(NSInteger)_checks remember:(NSInteger)_remember userId:(NSInteger)_userId flag:(NSInteger)_flag
{
    if (self = [super init]) {
        self.wordId = _wordId;
...
+(id) find:(NSString *)key userId:(NSInteger)userId
{
	...
	if([rs next]) {
        ...
        word = [[MusicWord alloc] initWithMusicWord:wordId key:key audio:audio pron:pron def:def date:date checks:checks remember:remember userId:userId flag:flag];
	}
	else {
...
+ (NSMutableArray *) findDelWords:(NSInteger)userId
{
	...
	while ([rs next]) {
        ...
        NSInteger userId = [rs intForColumn:@"userId"];
        NSInteger flag = [rs intForColumn:@"flg"];
        MusicWord *word = [[MusicWord alloc] initWithMusicWord:wordId key:key audio:audio pron:pron def:def date:date checks:checks remember:remember userId:userId flag:flag];
