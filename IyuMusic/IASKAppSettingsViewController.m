...
//	}
    ...
    NSString * header = [self.settingsReader titleForSection:section];
    UIView * headView = [[UIView alloc] initWithFrame:CGRectMake(10, 10, 300, 30)];
...
//    NSString *footerText = [self.settingsReader footerTextForSection:section];
    if (section!=4) {
        ...
        return 50.0+kIASKVerticalPaddingGroupTitles;
    }
}
- (UIView *)tableView:(UITableView *)tableView viewForFooterInSection:(NSInteger)section{
    ...
    if (section != 4) {
        ...
        if ([Constants isPad]) {
            UIView * headView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, 768, 90)];
            headView.backgroundColor = [UIColor clearColor];
            MyLabel * titleLabel = [[MyLabel alloc] initWithFrame:CGRectMake(20, 10, headView.frame.size.width - 40, 40)];
            
            titleLabel.text = footerText;
            [headView addSubview:titleLabel];
            headView.frame = CGRectMake(0, 0, 768, titleLabel.frame.size.height + kIASKVerticalPaddingGroupTitles);
            //    titleLabel.textColor = [UIColor colorWithRed:0.682 green:0.329 blue:0.0 alpha:1];
            if ([Constants isPad]) {
                titleLabel.textColor = [UIColor blackColor];
            } else {
...
//    NSLog(@"112232");
    ...
    if ([[specifier type] isEqualToString:kIASKPSToggleSwitchSpecifier]) {
        ...
        [cell setBackgroundColor:[UIColor colorWithRed:219.0/255 green:227.0/255 blue:240.0/255 alpha:1]];/////
        return cell;
    }
...
//        NSLog(@"defaultValue:%@",[self.settingsStore objectForKey:key]);
        [cell setBackgroundColor:[UIColor colorWithRed:219.0/255 green:227.0/255 blue:240.0/255 alpha:1]];/////
        return cell;
    }
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if ([[specifier type] isEqualToString:kIASKPSToggleSwitchSpecifier]) {
        ...
        if (vcClass) {
			...
			self.navigationController.delegate = nil;
            [self.navigationController.navigationBar setTintColor:[UIColor colorWithRed:0 green:0 blue:1.0 alpha:1]];/////
//            [self.navigationController.navigationBar setTintColor:[UIColor colorWithPatternImage:[UIImage imageNamed:@"title栏按钮.png"]]];
