...
- (void)viewWillAppear:(BOOL)animated {
    ...
    if ([Constants isPad]) {
        [contentBg setImage:[UIImage imageNamed:@"contentBg@2x.png"]];
        [contentBg setFrame:CGRectMake(20, 0, 728, 897)];
    } else {
        [contentBg setImage:[UIImage imageNamed:@"contentBg.png"]];
        if (IS_IPHONE_5) {
            [contentBg setFrame:CGRectMake(9, 0, 302, 411+88)];

        } else {
            [contentBg setFrame:CGRectMake(9, 0, 302, 411)];
